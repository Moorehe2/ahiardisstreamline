...
st.text (The datasets are data from hospital in the United States from CMS for diagnsis, total charges and payments.  First I will load the datasets then make a comparison between SUNY/Stony Brook University Hospitals with Bronx Lebanon Hospital, St. Barnabas Hospital and Montefiore Medical Center)
